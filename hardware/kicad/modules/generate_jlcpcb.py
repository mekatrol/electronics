...
GERBER_LAYERS = (
    ...
    "B.Mask",
    "Edge.Cuts",
    # Panel V-score centre lines generated by panelize_pcb.py. KiCad writes
    # this canonical layer as <project>-User_Drawings.gbr, which makes the
    # fabrication intent visible without misrepresenting scores as routed
    # Edge.Cuts geometry.
    "Dwgs.User",
)
